...
/// <summary>
/// Remote tests demonstrating OAuth2 Authentication against a deployed API.
/// Showcases the Client Credentials flow with automatic token management.
/// </summary>
/// <remarks>
/// Tests OAuth2 authentication endpoints against a remote server.
/// Requires remote API to be configured in testsettings.json.
/// </remarks>
public class OAuth2AuthTests : HttpSamplesRemoteTestBase, IClassFixture<HttpSamplesRemoteFixture>
{
	public OAuth2AuthTests(HttpSamplesRemoteFixture fixture) : base(fixture)
	{
	}

	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Token Endpoint with valid credentials should return access token")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Token Endpoint with invalid client ID should return 401 Unauthorized")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Token Endpoint with invalid client secret should return 401 Unauthorized")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Token Endpoint with unsupported grant type should return 400 Bad Request")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Complete Flow should get token and access protected endpoint successfully")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Protected Endpoint without token should return 401 Unauthorized")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Protected Endpoint with invalid token should return 401 Unauthorized")]
	...
	[Fact(Skip = "Remote test - WithOAuth2 extension requires OAuth2Handler implementation fix for form-urlencoded", DisplayName = "OAuth2 using XUnitAssured OAuth2 extension should authenticate automatically")]
	public void Example08_OAuth2_UsingXUnitAssuredOAuth2Extension()
	{
		// Arrange
		var tokenUrl = $"{BaseUrl}/api/auth/oauth2/token";
		var clientId = "test-client-id";
		var clientSecret = "test-client-secret";
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 with scopes should include requested scopes in token response")]
	...
	[Fact(Skip = "Remote test - WithOAuth2Config extension requires OAuth2Handler implementation fix for form-urlencoded", DisplayName = "OAuth2 using custom configuration should authenticate successfully")]
	...
	[Fact(Skip = "Remote test - WithOAuth2 extension requires OAuth2Handler implementation fix for form-urlencoded", DisplayName = "OAuth2 multiple requests should reuse cached token")]
	...
	[Fact(Skip = "Remote test - requires deployed API environment", DisplayName = "OAuth2 Token Response should return complete and valid structure")]
